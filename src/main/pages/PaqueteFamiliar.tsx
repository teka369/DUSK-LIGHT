...
const PaqueteFamiliar: React.FC = () => {
  ...
  const images: Image[] = [
    { src: '/DUSK-LIGHT/sesion familiar/WhatsApp Image 2025-10-23 at 15.39.26 (1).jpeg', alt: 'Imagen 1' },
    { src: '/DUSK-LIGHT/sesion familiar/WhatsApp Image 2025-10-23 at 15.39.26.jpeg', alt: 'Imagen 2' },
  ];
