...
const PaquetePareja: React.FC = () => {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  const images: Image[] = [
    { src: '/DUSK-LIGHT/sesion pareja/WhatsApp Image 2025-10-23 at 15.38.22.jpeg', alt: 'Imagen 1' },
    { src: '/DUSK-LIGHT/sesion pareja/WhatsApp Image 2025-10-23 at 15.38.22 (1).jpeg', alt: 'Imagen 2' },
  ];
      ...
      <section className="container-fluid py-fluid-lg">
        <div className="text-center mb-fluid-xl">
          ...
          <p className="text-fluid-lg text-[#B3B3B3] max-w-3xl mx-auto">
            Fotografía romántica para parejas. Incluye 30 fotos editadas y álbum digital.
          </p>
        </div>
