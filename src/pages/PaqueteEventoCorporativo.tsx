...
const PaqueteEventoCorporativo: React.FC = () => {
      ...
      <section className="container-fluid py-fluid-lg">
        <div className="text-center mb-fluid-xl">
          ...
          <p className="text-fluid-lg text-[#B3B3B3] max-w-3xl mx-auto">
            Fotografía automovilistica personalizada. Incluye edición y entrega en 48h.
          </p>
        </div>
...
export default PaqueteEventoCorporativo;
