...
const PaqueteFamiliar: React.FC = () => {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  const images: Image[] = [
    { src: `${import.meta.env.BASE_URL}images/session-family/WhatsApp Image 2025-10-23 at 15.39.26 (1).jpeg`, alt: 'Imagen 1' },
    { src: `${import.meta.env.BASE_URL}images/session-family/WhatsApp Image 2025-10-23 at 15.39.26.jpeg`, alt: 'Imagen 2' },
  ];
      ...
      <section className="container-fluid py-fluid-lg">
        <div className="text-center mb-fluid-xl">
          ...
          <p className="text-fluid-lg text-[#B3B3B3] max-w-3xl mx-auto">
            Fotografía familiar completa. Hasta 6 personas. Incluye 40 fotos editadas.
          </p>
        </div>
...
export default PaqueteFamiliar;
